...
- chore: bump VERSION to 1.4.19 to push mypy fix to upstream (`bb140a1`)
- fix: annotate device dict in test_quasar to satisfy mypy strict (`aa3fb9d`)
- style: auto-fix ruff (`e387707`)
...
- Reverse-synced upstream PR #5510 (WIP)
