...
export default defineConfig({
	site: 'https://trudenboy.github.io/ma-provider-yandex-station',
	base: '/ma-provider-yandex-station',
	integrations: [
		starlight({
			title: 'Yandex Station · MA Provider',
			locales: {
			...
			defaultLocale: 'root',
			editLink: {
				baseUrl: 'https://github.com/trudenboy/ma-provider-yandex-station/edit/dev/docs-site/src/content/docs/',
			},
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/trudenboy/ma-provider-yandex-station' },
			],
			sidebar: [
