...
# Yandex Station — Управление инцидентами

## Куда заводить инциденты

> **Заводи задачи здесь:** [github.com/trudenboy/ma-provider-yandex-station/issues](https://github.com/trudenboy/ma-provider-yandex-station/issues)
...
- **Поле Provider**: устанавливается автоматически для Yandex Station
