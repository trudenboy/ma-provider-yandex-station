...
# Yandex Station — локальная разработка через Docker

Запусти полноценный Music Assistant с провайдером Yandex Station одной командой —
...
## Подключение провайдера Yandex Station

После входа:

1. Перейди в **Settings** → **Providers**
2. Найди **Yandex Station** в списке — он уже доступен, код загружен автоматически
